        ...
        <div className="friendship">
            {friendship?.friends ? (
                <div className="friends_menu_wrap">
                    <button className="gray_btn" onClick={() => setFriendsMenu(true)}>
                        <img src="../../../public/icons/friends.png" alt="" />
                        <span>Friends</span>
                    </button>
                    {friendsMenu && (
                        <div className="open_cover_menu" ref={menu}>
                            <div className="open_cover_menu_item hover1">
                                <img src="../../../public/icons/favoritesOutline.png" alt="" />
                                Favorites
                            </div>
                            <div className="open_cover_menu_item hover1">
                                <img src="../../../public/icons/editFriends.png" alt="" />
                                Edit Friend list
                            </div>
                            {friendship?.following ? (
                                ...
                                >
                                    <img src="../../../public/icons/unfollowOutlined.png" alt="" />
                                    Unfollow
                                </div>
                            ) : (
                                <div
                ...
                !friendship?.requestReceived && (
                    <button className="blue_btn" onClick={() => addFriendHandler()}>
                        <img src="../../../public/icons/addFriend.png" alt="" className="invert" />
            ...
            {friendship?.requestSent ? (
                <button className="blue_btn" onClick={() => cancelRequestHandler()}>
                    <img
                        src="../../../public/icons/cancelRequest.png"
                        className="invert"
                        alt=""
                    />
            ...
            <div className="flex">
                {friendship?.following ? (
                    <button className="gray_btn" onClick={() => unfollowHandler()}>
                        <img src="../../../public/icons/follow.png" alt="" />
                        <span>Following</span>
                    </button>
                ) : (
                    <button className="blue_btn" onClick={() => followHandler()}>
                        <img src="../../../public/icons/follow.png" className="invert" alt="" />
                        <span>Follow</span>
                    </button>
                )}
